...
use crate::wallet_v1::wallet_inner::new_hardened_wallet_inner;
...
pub fn new_wallet_actor (wallet_seed: String,receiver:mpsc::Receiver<WalletCommand>) -> Result<WalletActor, WalletActorError> {
    let tmp_result=new_hardened_wallet_inner(wallet_seed);
    match tmp_result {
